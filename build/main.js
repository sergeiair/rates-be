...
class AnalyzeDataService {
  ...
  getAllCompletedPredictions(email, params) {
    return realm__WEBPACK_IMPORTED_MODULE_0___default.a.open(this.config).then(realm => {
      return realm.objects('Prediction').filtered(`owner = "${email}" AND finalRate != ${0} AND time >= ${params.dateStart} AND verifyTime <= ${params.dateEnd}`).sorted('time', true);
    }).catch(e => {
...
/*!**********************************************!*\
  !*** ./modules/predictions/_routes/index.js ***!
  \**********************************************/
/*! exports provided: create, clearAll, getAll, prepareTFS, verifySingle, getPredRateByHistory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const clearAll = () => {
  router.del('/clear', _guards_authMiddlware__WEBPACK_IMPORTED_MODULE_2__["authMiddleware"], async (ctx, next) => {
    try {
      controller.clearAll(Object(_utils_session__WEBPACK_IMPORTED_MODULE_3__["getUserEmailFromSession"])(ctx));
      ctx.body = {
        message: 'Done!'
      };
    } catch (e) {
...
class PredictionsDataService {
  ...
  clearAll(email) {
    return realm__WEBPACK_IMPORTED_MODULE_1___default.a.open(this.config).then(realm => {
      const preds = realm.objects('Prediction').filtered(`owner = "${email}"`);
      realm.write(() => {
        realm.delete(preds);
      });
      realm.close();
...
const router = new koa_trie_router__WEBPACK_IMPORTED_MODULE_0___default.a();
/* harmony default export */ __webpack_exports__["default"] = (() => {
  router.del(Object(_routes__WEBPACK_IMPORTED_MODULE_1__["clearAll"])());
...
/*!**********************************************!*\
  !*** ./modules/rates-scheduler/constants.js ***!
  \**********************************************/
/*! exports provided: DATA_SOURCE_ENDPOINT, PAIRS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const PAIRS = ['EUR/USD', 'EUR/PLN', 'EUR/CHF', 'EUR/GBP', 'USD/NOK', 'GBP/USD', 'USD/RUB', 'USD/CHF', 'USD/PLN', 'USD/JPY'];
...
class RatesSchedulerController {
  ...
  updateStaticStore(rates) {
    _static_rates__WEBPACK_IMPORTED_MODULE_1__["StaticRatesStore"].updateLocalLatest(rates);
  }

  isSaveAllowed(rates) {
    return _static_rates__WEBPACK_IMPORTED_MODULE_1__["StaticRatesStore"].isNewValue(rates);
  }
...
class RatesSchedulerDataService {
  ...
  storeSingle(rates) {
    realm__WEBPACK_IMPORTED_MODULE_0___default.a.open(this.config).then(realm => {
      realm.write(() => {
        realm.create('Rate', _objectSpread({
          id: Date.now(),
          time: new Date().toISOString()
        }, this.getStorageRatesValues(rates)), realm__WEBPACK_IMPORTED_MODULE_0___default.a.UpdateMode.Never);
      });
      realm.close();
    }).catch(e => {
      _logger__WEBPACK_IMPORTED_MODULE_2__["AppLogger"].error(e);
...
class RatesSchedulerService {
  static get requestPairs() {
    return _constants__WEBPACK_IMPORTED_MODULE_0__["PAIRS"].map(pair => pair.replace('/', '')).join();
  }
  ...
  static requestData(currency) {
    if (_static_rates__WEBPACK_IMPORTED_MODULE_1__["StaticRatesStore"].isRequiredTimePassed()) {
      ...
      axios.get(`${this.endpoint}&currency=${this.requestPairs}`).then(response => this.dataFetched(currency, response.data)).catch(console.error);
    }
  }
...
class RatesDataService {
  ...
  getHistory(number) {
    return realm__WEBPACK_IMPORTED_MODULE_0___default.a.open(this.config).then(realm => {
      return realm.objects('Rate').sorted('id', true).slice(0, number);
    }).catch(e => {
      _logger__WEBPACK_IMPORTED_MODULE_2__["AppLogger"].error(e);
    });
  }
...
/***/ "./modules/stats/_routes/index.js":
/*!****************************************!*\
  !*** ./modules/stats/_routes/index.js ***!
  \****************************************/
...
/* harmony import */ var _controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../controller */ "./modules/stats/controller.js");
/* harmony import */ var _data_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../data.service */ "./modules/stats/data.service.js");
/* harmony import */ var _guards_authMiddlware__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../guards/authMiddlware */ "./guards/authMiddlware.js");
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../logger */ "./logger/index.js");
...
class StatsController {
  ...
  getStats() {
    return Promise.all([this.dataService.getUsersCount(), this.dataService.getPredsCount(), this.dataService.getHistoryCount()]);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StatsDataService; });
/* harmony import */ var realm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! realm */ "realm");
/* harmony import */ var realm__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(realm__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _db_schemes_rates__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../db/schemes/rates */ "./db/schemes/rates.js");
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../logger */ "./logger/index.js");
/* harmony import */ var _db_schemes_prediction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../db/schemes/prediction */ "./db/schemes/prediction.js");
/* harmony import */ var _db_schemes_user__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../db/schemes/user */ "./db/schemes/user.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class StatsDataService {
  constructor() {
    _defineProperty(this, "ratesConfig", {
      schema: [_db_schemes_rates__WEBPACK_IMPORTED_MODULE_1__["RateSchema"]],
      deleteRealmIfMigrationNeeded: true,
      path: './db/files/rates/01.realm'
    });

    _defineProperty(this, "predsConfig", {
      schema: [_db_schemes_prediction__WEBPACK_IMPORTED_MODULE_3__["PredictionSchema"]],
      deleteRealmIfMigrationNeeded: true,
      path: './db/files/predictions/01.realm'
    });

    _defineProperty(this, "usersConfig", {
      schema: [_db_schemes_user__WEBPACK_IMPORTED_MODULE_4__["UserSchema"]],
      deleteRealmIfMigrationNeeded: true,
  ...
  getHistoryCount() {
    return realm__WEBPACK_IMPORTED_MODULE_0___default.a.open(this.ratesConfig).then(realm => {
  ...
  getUsersCount() {
    return realm__WEBPACK_IMPORTED_MODULE_0___default.a.open(this.usersConfig).then(realm => {
  ...
  getPredsCount() {
    return realm__WEBPACK_IMPORTED_MODULE_0___default.a.open(this.predsConfig).then(realm => {
...
/* harmony import */ var koa_trie_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! koa-trie-router */ "koa-trie-router");
/* harmony import */ var koa_trie_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(koa_trie_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_routes */ "./modules/stats/_routes/index.js");
...
const router = new koa_trie_router__WEBPACK_IMPORTED_MODULE_0___default.a();
/* harmony default export */ __webpack_exports__["default"] = (() => {
  router.get(Object(_routes__WEBPACK_IMPORTED_MODULE_1__["getStats"])());
  return router.middleware();
});
...
/* harmony import */ var stats__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! stats */ "./modules/stats/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  router.use(koa_mount__WEBPACK_IMPORTED_MODULE_1___default()('/stats', Object(stats__WEBPACK_IMPORTED_MODULE_8__["default"])()));
  return router.middleware();
});
...
/* harmony import */ var _modules_rates_scheduler_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/rates-scheduler/constants */ "./modules/rates-scheduler/constants.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }
...
class StaticRatesStore {
  static get latestRates() {
    if (!this._latestRates || !Object.keys(this._latestRates).length) {
      this._latestRates = _modules_rates_scheduler_constants__WEBPACK_IMPORTED_MODULE_0__["PAIRS"].reduce((acc, curr) => _objectSpread(_objectSpread({}, acc), {}, {
        [curr]: 0
      }), {});
    }
  ...
  static isNewValue(rates) {
    return Object.keys(rates || {}).some(pair => rates[pair] !== this.latestRates[pair]);
  }
...
_defineProperty(StaticRatesStore, "requiredMsGap", 5 * 60 * 1000);

_defineProperty(StaticRatesStore, "_latestRates", {});
